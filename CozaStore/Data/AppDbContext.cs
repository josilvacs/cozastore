...
public class AppDbContext : IdentityDbContext
{
    ...
    public DbSet<CarrinhoProduto> CarrinhosProdutos { get; set; }
    public DbSet<Categoria> Categorias { get; set; }
    public DbSet<Cor> Cores { get; set; }
    public DbSet<ListaDesejo> ListaDesejos { get; set; }
    public DbSet<Produto> Produtos { get; set; }
    public DbSet<ProdutoAvaliacao> ProdutosAvaliacoes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ProdutoAvaliacao>()
            ...
            .HasForeignKey(pa => pa.Usuario);
        #endregion

        #region Relacionamento Muitos para Muitos - ProdutoCategotia
